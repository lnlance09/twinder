...
?>
		<div id="header-section">
            <div id="signin">
                ...
                <div class="col-lg-12">
                    <p>
                        WeTinder is essentially just Tinder for the web. 
                        Everything that you do while logged into WeTinder will also be done on the app itself. 
                        But, the opposite is not true; nothing that you do on the actual Tinder app will be reflected on WeTinder.
                    </p>
